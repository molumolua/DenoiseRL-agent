...
class GamefilePoolCurriculumTest(unittest.TestCase):
    def test_initial_active_batch_is_first_pool_slice_at_zero_rho(self):
        curriculum = GamefilePoolCurriculum([10, 11, 12, 13], batch_size=2)
    ...
    def test_each_problem_updates_from_its_own_average_accuracy(self):
        curriculum = GamefilePoolCurriculum(
            [10, 11, 12],
            batch_size=2,
            target_accuracy=0.5,
            alpha=0.1,
    ...
    def test_small_positive_and_negative_slopes_are_stable(self):
        decreasing = GamefilePoolCurriculum(
            [10, 11],
            batch_size=1,
            initial_rho=0.3,
            target_accuracy=1.0,
        ...
        increasing = GamefilePoolCurriculum(
            [20, 21],
            batch_size=1,
            target_accuracy=0.0,
            alpha=0.005,
    ...
    def test_checkpoint_round_trip_preserves_active_batch_and_history(self):
        ...
        restored = GamefilePoolCurriculum(
            [10, 11, 12], batch_size=2, target_accuracy=0.5
        )
