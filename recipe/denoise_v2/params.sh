...
# Reuse the existing ALFWorld/downloaded parquet assets from v1 by default.
# Denoise v2 checkpoints and dumps still stay under this recipe's own paths.
LOCAL_DATA_DIR=${LOCAL_DATA_DIR:-"${RECIPE_DIR}/../alfworld_denoise/local_data"}
