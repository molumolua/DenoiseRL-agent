"""Ordered-pool, per-gamefile noise curriculum for ALFWorld DenoiseRL v2."""
...
class GamefilePoolCurriculum:
    """Maintain one noise ratio per gamefile in a deterministic active pool batch."""
